...
filename = sprintf('mat/neurosynth_rsa_HRR_groundtruth_avg_us=%d_nperms=%d.mat', use_smooth, nperms);
...
%filename = sprintf('mat/searchlight_rsa_HRR_groundtruth_avg_us=%d_r=%.4f_nperms=%d.mat', use_smooth, radius, nperms);
...
for s = 1:length(subjects)
    ...
    for r = 1:length(roi_masks)
        ...
        U = U_all(:, whole_brain_mask(roi_mask));

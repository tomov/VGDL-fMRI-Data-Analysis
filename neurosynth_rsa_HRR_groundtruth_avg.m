...
filename = sprintf('mat/neurosynth_rsa_HRR_groundtruth_avg_us=%d.mat', use_smooth);
...
%filename = sprintf('mat/searchlight_rsa_HRR_groundtruth_avg_us=%d_r=%.4f.mat', use_smooth, radius);

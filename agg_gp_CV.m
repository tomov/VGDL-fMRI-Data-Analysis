...
for s = 1:1:length(subjects)
    ...
    %filename = sprintf('/n/holyscratch01/LABS/gershman_lab/Users/mtomov13/VGDL/mat/fit_gp_CV_subj=%d_us=1_glm=1_mask=mask_model=DQN25M_PCA_all_nsamples=100_project=2_norm=1_concat=0_novelty=1_fast=1_saveYhat=0_parts=123_games=all.mat', subj_id); %  DQN PCA no KW
    %filename = sprintf('/n/holyscratch01/LABS/gershman_lab/Users/mtomov13/VGDL/mat/fit_gp_CV_subj=%d_us=1_glm=1_mask=mask_model=PCA__nsamples=100_project=2_norm=1_concat=0_novelty=1_fast=1_saveYhat=0_parts=123_games=all.mat', subj_id); %  PCA no KW
    %filename = sprintf('/n/holyscratch01/LABS/gershman_lab/Users/mtomov13/VGDL/mat/fit_gp_CV_subj=%d_us=1_glm=1_mask=mask_model=VAE__nsamples=100_project=2_norm=1_concat=0_novelty=1_fast=1_saveYhat=0_parts=123_games=all.mat', subj_id); %  VAE no KW
    filename = sprintf('/n/holyscratch01/LABS/gershman_lab/Users/mtomov13/VGDL/mat/fit_gp_CV_subj=%d_us=1_glm=1_mask=mask_model=EMPA_approachavoid_theory_nsamples=100_project=1_norm=1_concat=0_novelty=1_fast=1_saveYhat=0_parts=123_games=all.mat', subj_id);
    filename

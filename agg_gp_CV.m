...
for s = 1:1:length(subjects)
    ...
    filename = sprintf('/n/holyscratch01/LABS/gershman_lab/Users/mtomov13/VGDL/mat/fit_gp_CV_subj=11_us=1_glm=1_mask=mask_model=VAE__nsamples=100_project=2_norm=1_concat=0_novelty=1_fast=1_saveYhat=0_parts=123_games=all.mat', subj_id); %  VAE no KW
    filename

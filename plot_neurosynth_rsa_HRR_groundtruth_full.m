...
%load('mat/neurosynth_rsa_HRR_groundtruth_full_us=0_nperms=1000_dist=correlation_game.mat');
%load('mat/neurosynth_rsa_HRR_groundtruth_full_us=0_nperms=1000_dist=correlation_sprite.mat');
%load('mat/neurosynth_rsa_HRR_groundtruth_full_us=0_nperms=1000_dist=correlation_interaction.mat');
load('mat/neurosynth_rsa_HRR_groundtruth_full_us=0_nperms=1000_dist=correlation_termination.mat');

function fit_gp_CV(subj, use_smooth, glmodel, mask, model_name, what, project, normalize, concat, novelty, fast, save_Y_hat, which_partitions, which_games, debug)
    ...
    switch model_name
        ...
        case 'theory_change_flag'
            [ker, features] = load_GLM_kernel(EXPT, 102, subj, {'theory_change_flag'}, 0, normalize);
        ...
        case 'sprite_change_flag'
            [ker, features] = load_GLM_kernel(EXPT, 103, subj, {'sprite_change_flag'}, 0, normalize);
        ...
        case 'interaction_change_flag'
            [ker, features] = load_GLM_kernel(EXPT, 104, subj, {'interaction_change_flag'}, 0, normalize);
        ...
        case 'termination_change_flag'
            [ker, features] = load_GLM_kernel(EXPT, 105, subj, {'termination_change_flag'}, 0, normalize);
            %[ker, features] = load_GLM_kernel(EXPT, 105, subj, [{'termination_change_flag'}, get_nuisance_regressor_names(subj)], 1, normalize);
        case 'multiplexing'
            [ker, features] = load_GLM_kernel(EXPT, 106, subj, {'sprite_change_flag','interaction_change_flag','termination_change_flag'}, 0, normalize);
    ...
    if save_Y_hat
        save(filename, 'sigma', 'logmarglik', 'logpredlik', 'R2', 'adjR2', 'r', 'MSE', 'SMSE', ... 
                       ...
                       'subj', 'use_smooth', 'glmodel', 'mask', 'what', 'sigmas', 'n', 'partition_id', 'partitions', 'Y', 'Y_hat_CV', 'Y_hat', 'all', ...
        '-v7.3');
    else
        save(filename, 'sigma', 'logmarglik', 'logpredlik', 'R2', 'adjR2', 'r', 'MSE', 'SMSE', ... 
                       'sigma_CV', 'logmarglik_CV', 'logpredlik_CV', 'R2_CV', 'adjR2_CV', 'r_CV', 'MSE_CV', 'SMSE_CV', ...
                       'ceil_sigma', 'ceil_logmarglik', 'ceil_logpseudolik', 'ceil_R2', 'ceil_adjR2', 'ceil_r', 'ceil_MSE', 'ceil_SMSE', ...
                       'ceil_sigma_CV', 'ceil_logmarglik_CV', 'ceil_logpseudolik_CV', 'ceil_R2_CV', 'ceil_adjR2_CV', 'ceil_r_CV', 'ceil_MSE_CV', 'ceil_SMSE_CV', ...
                       'subj', 'use_smooth', 'glmodel', 'mask', 'what', 'sigmas', 'n', 'partition_id', 'partitions', 'all', ...
        '-v7.3');
    end

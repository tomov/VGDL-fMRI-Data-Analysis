...
for subj in ${subjects[*]}; do
    ...
    # send the job to NCF
    #
    sbatch_output=`sbatch -p ncf --mem 20001 -t 0-5:20 -o ${outfileprefix}_%j.out -e ${outfileprefix}_%j.err --wrap="matlab -nodisplay -nosplash -nojvm -r $'fit_gp_CV(${subj}, ${use_smooth}, ${glmodel}, \'${mask}\', \'${what}\', ${fast});exit'"`
    # for local testing

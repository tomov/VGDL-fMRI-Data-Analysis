...
%    fullfile(get_mat_dir(2), 'fit_gp_CV_subj=%d_us=1_glm=1_mask=mask_model=VAE__nsamples=100_project=1_norm=1_concat=0_novelty=1_fast=1_saveYhat=0.mat'), ... % e1k
    '/n/holyscratch01/LABS/gershman_lab/Users/mtomov13/VGDL/mat/fit_gp_CV_subj=%d_us=1_glm=1_mask=mask_model=game__nsamples=100_project=1_norm=1_concat=0_novelty=1_fast=1_saveYhat=0_parts=123.mat', ...
};
% archive

...
fasse_ncf = false;
agg_filename = fullfile(get_mat_dir(fasse_ncf), sprintf('gp_CV_rois_alpha=%.3f_atlas=%s_no_project.mat', alpha, atlas));
agg_filename
...
for reg = 1:nregressors
    ...
    for s = 1:nsubjects
        ...
        significant = (p < alpha) & (r > 0); % which boxes are significant

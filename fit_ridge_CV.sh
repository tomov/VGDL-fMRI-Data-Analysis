...
for subj in ${subjects[*]}; do
    ...
    # send the job to NCF
    #
    sbatch_output=`sbatch -p ncf --mem 20001 -t 0-3:20 -o ${outfileprefix}_%j.out -e ${outfileprefix}_%j.err --wrap="matlab -nodisplay -nosplash -nojvm -r $'fit_ridge_CV(${subj}, ${use_smooth}, ${glmodel}, \'${mask}\');exit'"`
    # for local testing

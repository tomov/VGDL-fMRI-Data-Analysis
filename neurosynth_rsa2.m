function neurosynth_rsa2(subj, use_smooth, glmodel, mask, model_name, what, project)
    % duplicate with fit_gp_CV
    ...
    filename = sprintf('mat/neurosynth_rsa2_subj=%d_us=%d_glm=%d_mask=%s_model=%s_%s_nsamples=100_project=%d_dist=%s.mat', subj, use_smooth, glmodel, maskname, model_name, what, project, neural_distance);
    filename
    ...
    % load parcellation
    load('mat/get_neurosynth_rois_1.mat', 'region', 'roi_masks'); % generated by get_neurosynth_rois

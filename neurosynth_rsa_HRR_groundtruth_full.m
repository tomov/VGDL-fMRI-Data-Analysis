...
filename = sprintf('mat/neurosynth_rsa_HRR_groundtruth_full_us=%d_nperms=%d_dist=%s.mat', use_smooth, nperms, dist);
...
%filename = sprintf('mat/searchlight_rsa_HRR_groundtruth_full_us=%d_r=%.4f_nperms=%d.mat', use_smooth, radius, nperms);
...
for s = 1:length(subjects)
    ...
    for r = 1:length(roi_masks)
        ...
        for k = 1:nperms
            ...
            for i = 1:n
                for j = 1:n
                    null_HRR_RDM(i,j) = mean_RDM(features(i), features(j));

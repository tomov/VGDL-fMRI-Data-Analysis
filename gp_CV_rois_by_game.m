...
filename_templates = { ...
    ...
    fullfile(get_mat_dir(2), 'fit_gp_CV_subj=%d_us=1_glm=1_mask=mask_model=DQN25M_all_nsamples=100_project=1_norm=1_concat=0_novelty=1_fast=1_saveYhat=0_parts=123_games=%s.mat'), ...

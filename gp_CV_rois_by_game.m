...
agg_filename = fullfile(get_mat_dir(fasse_ncf), sprintf('gp_CV_rois_by_game_alpha=%.3f_atlas=%s_project=1_neuron.mat', alpha, atlas));
agg_filename
...
filename_templates = { ...
    fullfile(get_mat_dir(2), 'fit_gp_CV_subj=%d_us=1_glm=1_mask=mask_model=EMPA_theory_nsamples=100_project=1_norm=1_concat=0_novelty=1_fast=1_saveYhat=1_parts=123_games=%s.mat'), ...
    fullfile(get_mat_dir(2), 'fit_gp_CV_subj=%d_us=1_glm=1_mask=mask_model=DQN25M_PCA_all_nsamples=100_project=1_norm=1_concat=0_novelty=1_fast=1_saveYhat=0_parts=123_games=%s.mat'), ...
    fullfile(get_mat_dir(2), 'fit_gp_CV_subj=%d_us=1_glm=1_mask=mask_model=PCA__nsamples=100_project=1_norm=1_concat=0_novelty=1_fast=1_saveYhat=0_parts=123_games=%s.mat'), ...
    fullfile(get_mat_dir(2), 'fit_gp_CV_subj=%d_us=1_glm=1_mask=mask_model=VAE__nsamples=100_project=1_norm=1_concat=0_novelty=1_fast=1_saveYhat=0_parts=123_games=%s.mat'), ...
};

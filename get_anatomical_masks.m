...
% more ROIs
roi_labels_AAL2_GP_EMPA2_grouped = { ...
    {'Frontal_Inf_Tri_L', 'Frontal_Inf_Tri_R', 'Frontal_Inf_Oper_L', 'Frontal_Inf_Oper_R', 'Frontal_Mid_2_L', 'Frontal_Mid_2_R', 'Frontal_Sup_2_L', 'Frontal_Sup_2_R', 'Frontal_Sup_Medial_L', 'Frontal_Sup_Medial_R', 'Precentral_L', 'Precentral_R', 'Supp_Motor_Area_L', 'Supp_Motor_Area_R'}, ... 
    {'Postcentral_L', 'Postcentral_R', 'Parietal_Inf_L', 'Parietal_Inf_R', 'Angular_L', 'Angular_R', 'Occipital_Sup_L', 'Occipital_Sup_R', 'SupraMarginal_L', 'SupraMarginal_R', 'Rolandic_Oper_L', 'Rolandic_Oper_R', 'Precuneus_L', 'Precuneus_R'}, ... 
    {'Occipital_Inf_L', 'Occipital_Inf_R', 'Occipital_Mid_L', 'Occipital_Mid_R', 'Fusiform_L', 'Fusiform_R', 'Temporal_Mid_L', 'Temporal_Mid_R'}, ...
    {'Lingual_L', 'Lingual_R', 'Calcarine_L', 'Calcarine_R', 'Cuneus_L', 'Cuneus_R'}, ...
};

roi_names_AAL2_GP_EMPA2_grouped = { ...
    'Motor + Frontal', ...
    'Dorsal_Parietal', ...
    'Ventral_Temporal', ...
    'Early visual', ...
...
% Goes together with AAL2_GP_EMPA2_grouped
roi_labels_AAL2_GP_EMPA2 = { ...
    {'Frontal_Inf_Tri_L', 'Frontal_Inf_Tri_R'}, ...
    {'Frontal_Inf_Oper_L', 'Frontal_Inf_Oper_R'}, ...
    {'Frontal_Mid_2_L', 'Frontal_Mid_2_R'}, ...
    {'Frontal_Sup_2_L', 'Frontal_Sup_2_R'}, ...
...
roi_labels_AAL3_neuron = { ...
    ...
    {'Temporal_Pole_Sup_L', 'Temporal_Pole_Sup_R', 'Temporal_Pole_Mid_L', 'Temporal_Pole_Mid_R'}, ...
    {'N_Acc_L', 'N_Acc_R'}, ...
    {'VTA_L', 'VTA_R'}, ...
    {'SN_pc_L', 'SN_pc_R'}, ...
};

roi_names_AAL3_neuron = { ...
    'OFCmed', ...
    'OFCant', ...
    'OFCpost', ...
    'OFClat', ...
...
roi_labels_AAL2_gross = { ...
{'Precentral_L', 'Precentral_R', 'Frontal_Sup_2_L', 'Frontal_Sup_2_R', 'Frontal_Mid_2_L', 'Frontal_Mid_2_R', 'Frontal_Inf_Oper_L', 'Frontal_Inf_Oper_R', 'Frontal_Inf_Tri_L', 'Frontal_Inf_Tri_R', 'Frontal_Inf_Orb_2_L', 'Frontal_Inf_Orb_2_R', 'Rolandic_Oper_L', 'Rolandic_Oper_R', 'Supp_Motor_Area_L', 'Supp_Motor_Area_R', 'Olfactory_L', 'Olfactory_R', 'Frontal_Sup_Medial_L', 'Frontal_Sup_Medial_R', 'Frontal_Med_Orb_L', 'Frontal_Med_Orb_R', 'Rectus_L', 'Rectus_R', 'OFCmed_L', 'OFCmed_R', 'OFCant_L', 'OFCant_R', 'OFCpost_L', 'OFCpost_R', 'OFClat_L', 'OFClat_R', 'Insula_L', 'Insula_R', 'Cingulate_Ant_L', 'Cingulate_Ant_R', 'Cingulate_Mid_L', 'Cingulate_Mid_R'}, ...
{'Cingulate_Post_L', 'Cingulate_Post_R', 'Postcentral_L', 'Postcentral_R', 'Parietal_Sup_L', 'Parietal_Sup_R', 'Parietal_Inf_L', 'Parietal_Inf_R', 'SupraMarginal_L', 'SupraMarginal_R', 'Angular_L', 'Angular_R', 'Precuneus_L', 'Precuneus_R', 'Paracentral_Lobule_L', 'Paracentral_Lobule_R', 'Occipital_Sup_L', 'Occipital_Sup_R'}, ...
{'Heschl_L', 'Heschl_R', 'Temporal_Sup_L', 'Temporal_Sup_R', 'Temporal_Pole_Sup_L', 'Temporal_Pole_Sup_R', 'Temporal_Mid_L', 'Temporal_Mid_R', 'Temporal_Pole_Mid_L', 'Temporal_Pole_Mid_R', 'Temporal_Inf_L', 'Temporal_Inf_R', 'Fusiform_L', 'Fusiform_R', 'Occipital_Mid_L', 'Occipital_Mid_R', 'Occipital_Inf_L', 'Occipital_Inf_R'}, ...
{'Lingual_L', 'Lingual_R', 'Calcarine_L', 'Calcarine_R', 'Cuneus_L', 'Cuneus_R'}, ...
};

roi_names_AAL2_gross = { ...
    'Motor + Frontal', ...
    'Dorsal_Parietal', ...
    'Ventral_Temporal', ...
    'Early visual', ...
...
switch atlas_name
    ...
    case 'AAL2_GP_EMPA'
        ...
        atlas_name = 'AAL2'; % proper atlas name
    case 'AAL2_GP_EMPA2_grouped'
        roi_labels = roi_labels_AAL2_GP_EMPA2_grouped;
        roi_names = roi_names_AAL2_GP_EMPA2_grouped;
        atlas_name = 'AAL2'; % proper atlas name
    case 'AAL2_GP_EMPA2'
        roi_labels = roi_labels_AAL2_GP_EMPA2;
        roi_names = roi_names_AAL2_GP_EMPA2;
        atlas_name = 'AAL2'; % proper atlas name
    ...
    case 'AAL3v1_neuron'
        roi_labels = roi_labels_AAL3_neuron;
        roi_names = roi_names_AAL3_neuron;
        atlas_name = 'AAL3v1';% proper atlas name
    case 'HarvardOxford'
    ...
    case 'AAL2_gross'
        roi_labels = roi_labels_AAL2_gross;
        roi_names = roi_names_AAL2_gross;
        atlas_name = 'AAL2';% proper atlas name
    otherwise

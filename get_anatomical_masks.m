...
% Goes together with AAL2_grouped5
roi_labels_AAL2_ungrouped3 = { ...
    {'Frontal_Inf_Tri_L', 'Frontal_Inf_Tri_R'}, ...
    {'Frontal_Inf_Oper_L', 'Frontal_Inf_Oper_R'}, ...
    {'Occipital_Sup_L', 'Occipital_Sup_R'}, ... % ------------
    {'Occipital_Inf_L', 'Occipital_Inf_R'}, ... % ----------
...
switch atlas_name
    ...
    case 'AAL2_ungrouped2'
        ...
        atlas_name = 'AAL2'; % proper atlas name
    case 'AAL2_grouped5'
        roi_labels = roi_labels_AAL2_grouped5;
        roi_names = roi_names_AAL2_grouped5;
        atlas_name = 'AAL2'; % proper atlas name
    case 'AAL2_ungrouped3'
        roi_labels = roi_labels_AAL2_ungrouped3;
        roi_names = roi_names_AAL2_ungrouped3;
        atlas_name = 'AAL2'; % proper atlas name
    case 'AAL3v1'
